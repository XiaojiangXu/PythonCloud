...
class Login(unittest.TestCase):
    ...
    def test_login(self):
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin1.png')
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin2.png')
        driver.implicitly_wait(30)
        driver.switch_to_default_content()
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin3.png')
        driver.implicitly_wait(30)
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin4.png')
        driver.implicitly_wait(30)
        now_handle = driver.current_window_handle #获取当前窗口句柄
        print 'first handle1 is',now_handle   #输出当前获取的窗口句柄
        ...
        for handle in all_handles:
            if handle != now_handle:
                ...
                driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin4_1.png')
                driver.find_element_by_name("button").click()
        print 'third handle1 is',now_handle #输出主窗口句柄
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin5.png')
        driver.implicitly_wait(30)
        now_handle = driver.current_window_handle #获取当前窗口句柄
        print 'first handle2 is',now_handle   #输出当前获取的窗口句柄
        all_handles = driver.window_handles #获取所有窗口句柄
        for handle in all_handles:
            if handle != now_handle:
                ...
                driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin5_1.png')
                driver.find_element_by_name("button").click()
        print 'third handle2 is',now_handle #输出主窗口句柄
        driver.switch_to_window(now_handle) #返回主窗口
        driver.implicitly_wait(30)
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin6.png')
        driver.implicitly_wait(30)
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin7.png')
        driver.implicitly_wait(30)
        ...
        driver.get_screenshot_as_file('C:\\Users\\Administrator\\Desktop\\python_cloud\\cloudlogin8.png')
